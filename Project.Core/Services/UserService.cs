...
namespace Project.Core.Services
{
    public class UserService : BaseService<User, UserViewModel>, IUserService
    {
        ...
        {
            var paginatedData = await _userRepository.GetPaginatedData(pageNumber, pageSize, cancellationToken);
        ...
        public async Task<UserViewModel> GetById(int id, CancellationToken cancellationToken)
        {
            ...
            return _userViewModelMapper.MapModel(await _userRepository.GetById(id, cancellationToken));
        }
